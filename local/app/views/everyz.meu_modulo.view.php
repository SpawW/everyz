...
* Module Variables
* ************************************************************************** */
$moduleName = "zbxe-meu_modulo";
$baseProfile .= $moduleName;
$moduleTitle = 'Palestrantes';
...
addFilterParameter("resumo", T_ZBX_STR, "Resultado da simulação!", true, false, false);
// Field validation
check_fields($fields);
...
//$tmpColumn->addRow(_zeT('Resumo'), (new CTextArea('resumo', $filter['resumo']))->setWidth(ZBX_TEXTAREA_BIG_WIDTH));
//$tmpColumn->addRow(new CSubmit('form', _zeT('Create hosts')));
$tmpColumn->addRow('Meu modulo... minhas fotos!');
...
<div class="slideshow-container">
   <img src="/4.0/local/app/everyz/images/slides/palestrante_01.png" style="width:10%; height: 10%;">
   <img src="/4.0/local/app/everyz/images/slides/palestrante_02.png" style="width:10%; height: 10%;">
   <img src="/4.0/local/app/everyz/images/slides/palestrante_03.png" style="width:10%; height: 10%;">
   <img src="/4.0/local/app/everyz/images/slides/palestrante_04.png" style="width:10%; height: 10%;">
   <img src="/4.0/local/app/everyz/images/slides/palestrante_05.png" style="width:10%; height: 10%;">
   <img src="/4.0/local/app/everyz/images/slides/palestrante_06.png" style="width:10%; height: 10%;">
   <img src="/4.0/local/app/everyz/images/slides/palestrante_07.png" style="width:10%; height: 10%;">
   <img src="/4.0/local/app/everyz/images/slides/palestrante_08.png" style="width:10%; height: 10%;">
   <img src="/4.0/local/app/everyz/images/slides/palestrante_09.png" style="width:10%; height: 10%;">
   <img src="/4.0/local/app/everyz/images/slides/palestrante_10.png" style="width:10%; height: 10%;">
   <img src="/4.0/local/app/everyz/images/slides/palestrante_11.png" style="width:10%; height: 10%;">
   <img src="/4.0/local/app/everyz/images/slides/palestrante_12.png" style="width:10%; height: 10%;">
   <img src="/4.0/local/app/everyz/images/slides/palestrante_13.png" style="width:10%; height: 10%;">
   <img src="/4.0/local/app/everyz/images/slides/palestrante_14.png" style="width:10%; height: 10%;">
   <img src="/4.0/local/app/everyz/images/slides/palestrante_15.png" style="width:10%; height: 10%;">
   <img src="/4.0/local/app/everyz/images/slides/palestrante_16.png" style="width:10%; height: 10%;">
</div>
<br>
<!-- fim comentario -->
...
<div>
  <script>
  if (Math.random() > 0.5) {
    document.write('<font size="15px">Acho que conheço este cara aí...</font><br>');
    document.write('<img src="/4.0/local/app/everyz/images/foto01.jpg" width="50%" height="50%"></img>');
  } else {
    document.write('<font size="15px">Olha quem está de roupa de gala!</font><br>');
    document.write('<img src="/4.0/local/app/everyz/images/foto02.jpg" width="50%" height="50%"></img>');
  }
  ///home/spaww/Downloads/alexei.jpg
  </script>
