...
* Date     * Objective                                                         *
* 20170919 * Limit maps configuration for versions before 3.4 of Zabbix        *
* */
...
$table->addRow(
  (new CFormList())
  ->addRow(_zeT('Default POI'), [$cmbDefaultPoi, (new CImg('imgstore.php?iconid=' . $idGeoDefaultPOI, 'cnf_geo_default_poi', 16, 16))->setId("img_geo_default_poi")])
);
/*
